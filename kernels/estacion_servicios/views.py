...
from kernels.estacion_servicios.models import FuelDispense, FuelSale, FuelShift
from kernels.estacion_servicios.serializers import (
    DispenseCreateIn,
    DispenseOut,
...
from kernels.estacion_servicios.services import (
