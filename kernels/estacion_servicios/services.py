...
from kernels.estacion_servicios.models import (
    FuelDispense,
    FuelSale,
    FuelSaleStatus,
    FuelShift,
...
def _get_or_create_fuel_item(*, request, company, actor_user, product: str):
    ...
    from kernels.inventarios.services import create_item
...
def create_sale(
    *,
    ...
    from kernels.inventarios.services import post_issue
    from kernels.facturacion.services import create_draft, issue_doc
    from kernels.facturacion.models import DocType
...
def _attempt_sale_compensation(*, request=None, sale: FuelSale, actor_user, reason: str = "") -> FuelSale:
    ...
    if sale.billing_doc_id:
        try:
            from kernels.facturacion.services import void_doc
    ...
    if sale.inventory_movement_id and not sale.inventory_reversal_movement_id:
        try:
            ...
            from kernels.inventarios.services import post_receive
