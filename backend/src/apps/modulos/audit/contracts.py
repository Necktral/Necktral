...
ALLOWED_EVENT_TYPES.update(
    {
        ...
        "REPORT_EXPORTED",
        "REPORT_READ_AUDITED",
        "DASHBOARD_WORKSPACE_VIEWED",
        "DASHBOARD_WIDGET_QUERIED",
        "DASHBOARD_DRILLDOWN_EXECUTED",
        "DASHBOARD_EMBED_TOKEN_ISSUED",
        "RETAIL_CONFIG_UPDATED",
        "RETAIL_TERMINAL_CREATED",
        "RETAIL_TICKET_OPENED",
        "RETAIL_TICKET_UPDATED",
        "RETAIL_TICKET_VOIDED",
        "RETAIL_HOLD_CREATED",
        "RETAIL_HOLD_RESUMED",
        "RETAIL_CHECKOUT_STARTED",
        "RETAIL_SALE_COMPLETED",
        "RETAIL_RETURN_CREATED",
        "RETAIL_RETURN_COMPLETED",
        "RETAIL_COMPENSATION_RETRIED",
        "RETAIL_COMPENSATION_FAILED",
    }
)
