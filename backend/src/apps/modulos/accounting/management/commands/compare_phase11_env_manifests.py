...
from apps.modulos.accounting.certification_phase11 import compare_phase11_env_manifests


class Command(BaseCommand):
    help = "Compara manifiestos Fase 11 y detecta drift de paridad."
    ...
    def handle(self, *args, **options):
        ...
        mismatches = compare_phase11_env_manifests(left=left, right=right)
        payload = {
        ...
        if bool(options.get("strict", False)) and mismatches:
            raise CommandError("phase11 manifest drift detected.")
