...
env = environ.Env(
    ...
    SYNC_MAX_REQUEST_SKEW_SECONDS=(int, 300),
    SYNC_HMAC_LEGACY_ENABLED=(bool, True),
    SYNC_HMAC_LEGACY_ALLOW_BRIDGE_CREATE=(bool, True),
    SYNC_HMAC_LEGACY_SUNSET=(str, ""),
...
SYNC_MAX_REQUEST_SKEW_SECONDS = env("SYNC_MAX_REQUEST_SKEW_SECONDS")
SYNC_HMAC_LEGACY_ENABLED = env("SYNC_HMAC_LEGACY_ENABLED")
SYNC_HMAC_LEGACY_ALLOW_BRIDGE_CREATE = env("SYNC_HMAC_LEGACY_ALLOW_BRIDGE_CREATE")
SYNC_HMAC_LEGACY_SUNSET = (env("SYNC_HMAC_LEGACY_SUNSET") or "").strip()
