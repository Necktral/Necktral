...
env = environ.Env(
    ...
    DASH_EMBED_BASE_URL=(str, ""),
    DASH_EMBED_SIGNING_KEY=(str, ""),
    DASH_EMBED_TOKEN_TTL_SECONDS=(int, 600),
)
...
DASH_EMBED_BASE_URL = env("DASH_EMBED_BASE_URL")
DASH_EMBED_SIGNING_KEY = env("DASH_EMBED_SIGNING_KEY")
DASH_EMBED_TOKEN_TTL_SECONDS = env("DASH_EMBED_TOKEN_TTL_SECONDS")
